...
//2) 노드환경이면 this는 global또는 globalThis
...
hong.printThis();//{ name: '홍길동', age: 30, printThis: [Function: printThis] }
...
const kang = {
    ...
    printThis() {
       ...
       //콜백함수를 화살표함수를 사용하면 콜백함수내의 this문제가 해결됨
