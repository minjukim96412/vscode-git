...
//이터러블이나 객체의 구성요소(요소, 프라퍼티)들을 
//각각의 변수에 나누어 할당
//1. 이터러블(배열, 문자열, Map, Set, NodeList, HTMLlements) => []
//2. 객체 => {}
...
//{ name: '홍길동', age: 30, gender: '남', address: '지구어딘가' }

//일부 프라퍼티만 할당
// const {name, address} = person;
// console.log(name, address);//홍길동 지구어딘가

// rest파라미터 사용
// const {name, ...rest} = person;
// console.log(name, rest);
//홍길동 { age: 30, gender: '남', address: '지구어딘가' }
...
// name: '홍길동', age: 20, hobby: [ '축구', '독서', '등산' ] 

// const {name, age, hobby:[soccer, reading, climbing]} = hong;
// console.log(name, age, soccer, reading, climbing);//홍길동 20 축구 독서 등산
