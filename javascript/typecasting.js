...
//1) new가 없는 생성자 함수 사용
// 2) 형변환 메서드 사용
// falsw로 판별될 수 있는 것들 : false, NaN, 0 , -0, undefiend, null, ''
// false:0, true:1
...
// 좌측 피연산자가 null 이나 undefined인 경우 undrfined로 처리
// => null 참조오류 회피
let elem2 = null;
console.log(elem2?.value); //undefined

//널 병합 연산자 (null coalescing perator) : ??
