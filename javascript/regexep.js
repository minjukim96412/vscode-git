...
//              전체 8자리 ~ 12자리 이하로 된 패턴
const strId = 'abcd1234';
id = (ele) => {
    console.log(/^[A-Za-z]{1}[A-Za-z0-9]{7,11}$/.test(ele));
}
id(strId);

//2) 주민번호 : 숫자6자리-숫자7자리
                // 년도2자리월2자리일2자리-성별숫자(1~4)숫자6개
const strSno = '990131-1234567';
//  /^\d{2}((0[1-9])|(1[0-2]))((0[1-9])|([1-2]\d)|(3[0-1]))-[1-4]\d{6}$/;
 const reSno =/^\d{2}((0[1-9]0[1-9])|(1[0-2]0[1-9])|(0[1-9])([1-2]\d))|(0(1|[3-9])3[0-1])-[1-4]\d{6}$/;
console.log(reSno.test(strSno));

//3) 아이피주소 : 숫자1~3자리,숫자1~3자리.숫자1~3자리.숫자1~3자리
//                  숫자는 0~255로 제한
const strIp = '127.88.0.100';
const reIp = /^((\d)|(\d{2})|([1]\d{2})|([2][0-4]\d)|([2][5][0-5])).((\d)|(\d{2})|([1]\d{2})|([2][0-4]\d)|([2][5][0-5])).((\d)|(\d{2})|([1]\d{2})|([2][0-4]\d)|([2][5][0-5])).((\d)|(\d{2})|([1]\d{2})|([2][0-4]\d)|([2][5][0-5]))$/;
