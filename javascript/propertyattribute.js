...
//getter /setter
//getter : 프라퍼티의 값을 획득, srttrt : 프라퍼티의 값을 변경
...
const person = {
    ...
    set fullName(name){
        //destructuring assigment (구조분해할당)
        //배열의 각각의 요소를 각각의 변수에 할당
        [this.firstName, this.lastName] = name.split(' ');
    }
};

person.fullName = '강 감찬';//set fullName 호출됨
console.log(person.firstName, person.lastName);
console.log(person.fullName);// get fullName 호출됨
...
lee.name = '장보고'; // writerable false 이므로 값 변경 불가
...
console.log(Object.keys(lee)); //enumerable : false이므로 age 만 검색

//객체 변경 불가
//1. 확장금지 : Object.perventExtensions => 프라퍼티 추가를 금지
