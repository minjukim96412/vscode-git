...
const todoPKG = {
    ...
    //조회
    getTodo: function(paramId: number): Todo {
        //id에 해당하는 todo객체를 추출하여 리턴
        return (todos2.filter(todo => todo.id === paramId))[0];
    },
    
    registTodo: function(paramTodo: Todo): void {
    ...
    updateTodo: function(paramTodo: Todo): Todo[] {
    ...
    //삭제
    deleteTodo: function(paramId: number): Todo[] {
        //id에 해당하는 todo가 존재하면
